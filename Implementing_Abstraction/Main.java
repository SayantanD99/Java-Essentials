...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String stringData = "5 7 8 9 6 4 3 2 1 0";
        ...
        String sdata = "Bolpur Santiniketan Sriniketan Prantik";
        String[] tdata = sdata.split(" ");
        ...
        tree.traverse(tree.getRoot());
        tree.removeItem(new Node("Bolpur"));
        tree.traverse(tree.getRoot());

        tree.removeItem(new Node("Sriniketan"));
        tree.traverse(tree.getRoot());
    }
}
