...
public class Main {
    ...
    public static void main(String[] args) {
        /**
         * Write a small program to read an integer from the keyboard(using Scanner) and
         * print out the times table for that number.
         ...
         * class instances and loop control variables that you may decide to use.
         *
